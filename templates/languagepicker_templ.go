...
func Langpicker() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<form class=\"w-full max-w-lg\" hx-post=\"biblecontentfinal\" hx-target=\"#biblecontent\"><input id=\"defaultlang\" type=\"hidden\" value=\"en\" name=\"defaultlang\"> <select id=\"langselect\" name=\"langselect\" class=\"block appearance-none w-full border-0 border-gray-200 text-gray-700 py-1.5 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500\">")
		...
		for _, item := range Languages() {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/languagepicker.templ`, Line: 57, Col: 41}
			}
